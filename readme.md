...
```bash
/bin/sh -c 'printf "%s\n" "{\"directory\":\"$1\",\"episode_path\":\"$2\",\"episode_name\":\"$3\",\"subtitle_path\":\"$4\",\"subtitles_language\":\"$5\",\"subtitles_language_code2\":\"$6\",\"subtitles_language_code2_dot\":\"$7\",\"subtitles_language_code3\":\"$8\",\"subtitles_language_code3_dot\":\"$9\",\"episode_language\":\"${10}\",\"episode_language_code2\":\"${11}\",\"episode_language_code3\":\"${12}\",\"score\":${13},\"subtitle_id\":\"${14}\",\"provider\":\"${15}\",\"uploader\":\"${16}\",\"release_info\":\"${17}\",\"series_id\":\"${18}\",\"episode_id\":\"${19}\",\"timestamp_utc\":\"$(date -u +%Y-%m-%dT%H:%M:%SZ)\"}" > "/subplz/jobs/${3}.json"' _ {{directory}} {{episode}} {{episode_name}} {{subtitles}} {{subtitles_language}} {{subtitles_language_code2}} {{subtitles_language_code2_dot}} {{subtitles_language_code3}} {{subtitles_language_code3_dot}} {{episode_language}} {{episode_language_code2}} {{episode_language_code3}} {{score}} {{subtitle_id}} {{provider}} {{uploader}} {{release_info}} {{series_id}} {{episode_id}}
```
