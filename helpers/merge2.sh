...
do
  ...
  docker_cmd="docker run -it --rm -u $(id -u):$(id -g) -v \"${audiobook_folder}\":/mnt sandreas/m4b-tool:2022-11-05 merge ${mp4_files} --output-file \"./${audiobook_name}.m4b\" --jobs $(nproc --all) --name \"${audiobook_name}\""
