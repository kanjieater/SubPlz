...
MAPPING="${3:-"./anki_importer/mapping.json"}"
...
python ./anki_importer/anki-importer.py --anki-connect-url="$ANKICONNECTURL" --path "$FOLDER/" --mapping "$MAPPING" --name "$NAME" --anki-media-dir "$ANKI_MEDIA_DIR"